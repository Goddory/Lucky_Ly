...
IL_022b:
	{
		...
		NullCheck(L_79);
		VirtualActionInvoker1< bool >::Invoke(10, L_79, ((*(bool*)UnBox(L_81, il2cpp_defaults.boolean_class))));
		return;
	}
...
IL_02c8:
	{
		...
		int64_t L_99 = V_15;
		NullCheck(L_98);
		VirtualActionInvoker1< int64_t >::Invoke(22, L_98, L_99);
		return;
	}
...
IL_02d6:
	{
		...
		NullCheck(L_104);
		NullCheck(L_103);
		VirtualActionInvoker1< int32_t >::Invoke(20, L_103, ((int32_t)(((RuntimeArray*)L_104)->max_length)));
		...
		NullCheck(L_105);
		VirtualActionInvoker1< uint8_t >::Invoke(11, L_105, L_107);
		...
		NullCheck(L_108);
		VirtualActionInvoker1< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(13, L_108, L_109);
		return;
	}
...
IL_031b:
	{
		...
		NullCheck(L_112);
		VirtualActionInvoker1< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(13, L_112, L_113);
		return;
	}
